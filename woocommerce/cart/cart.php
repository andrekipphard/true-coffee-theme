            ...
            <div class="col-12 col-lg-7">
                ...
                <?php do_action( 'woocommerce_before_cart' );?>
                    ...
                    <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
                        ...
                        <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents border-0 rounded-0" cellspacing="0">
                            <thead>
                                <tr>
                                    <th class="product-remove pt-4 pb-4"><span class="screen-reader-text"><?php esc_html_e( 'Remove item', 'woocommerce' ); ?></span></th>
                                    <th class="product-thumbnail pt-4 pb-4"><span class="screen-reader-text"><?php esc_html_e( 'Thumbnail image', 'woocommerce' ); ?></span></th>
                                    <th class="product-name pt-4 pb-4"><?php esc_html_e( 'Product', 'woocommerce' ); ?></th>
                                    <th class="product-price pt-4 pb-4"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
                                    <th class="product-quantity pt-4 pb-4"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></th>
                                    <th class="product-subtotal pt-4 pb-4"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                                    ...
                                    if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                                        ...
                                        <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                                            ...
                                            <td class="product-remove border-dark">
                                                <?php
                                            ...
                                            <td class="product-thumbnail border-dark pt-4 pb-4">
                                            <?php
                                            ...
                                            <td class="product-name border-dark pt-4 pb-4" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
                                            <?php
                                            if ( ! $product_permalink ) {
                                            ...
                                            <td class="product-price border-dark pt-4 pb-4" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
                                                <?php
                                                    echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key ); // PHPCS: XSS ok.
                                                ?>
                                            </td>

                                            <td class="product-quantity border-dark pt-4 pb-4" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
                                            <?php
                                            ...
                                            <td class="product-subtotal border-dark pt-4 pb-4" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
                                                <?php
